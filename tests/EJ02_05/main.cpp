...
uint32_t createVertexData(uint32_t *VBO, uint32_t *EBO) {	//Create VAO that compiles everything
	...
	uint32_t indices[] = {
		0,1,2,	//Triangle upper-right
		0,2,3,	//Triangle upper-middle
		0,3,4,	//Triangle upper-left
		0,4,5,	//Triangle lower-left
		0,5,6,	//Triangle lower-middle
		0,6,1	//Triangle lower-right
	};	
...
int main(int args, char* argv[]) {
	...
	window = glfwCreateWindow(800, 600, "EJ02_5", NULL, NULL);
	if (!window) {
