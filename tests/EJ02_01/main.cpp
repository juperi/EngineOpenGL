...
uint32_t createVertexData(uint32_t *VBO) {	//Create VAO that compiles everything
	//Two triangles
	float vertices[] = {
		//First triangle
		-1.0f, -0.5f, 0.0f,
...
int main(int args, char* argv[]) {
	...
	window = glfwCreateWindow(800, 600, "EJ02_1", NULL, NULL);
	if (!window) {
	...
	uint32_t VBO;
	uint32_t VAO = createVertexData(&VBO);	//Create Vertex Array Object that compiles everything
