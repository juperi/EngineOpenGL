...
int main(int args, char* argv[]) {
	...
	window = glfwCreateWindow(800, 600, "EJ04_01", NULL, NULL);
	if (!window) {
	...
	Shader shader("../tests/EJ04_01/vertex.vs", "../tests/EJ04_01/fragment.fs"); // Shaders path
	uint32_t VBO, EBO;
	uint32_t VAO = createVertexData(&VBO, &EBO); // Create Vertex Array Object that compiles everything
	
	// Create texture from images
	uint32_t tex1 = createTexture("../tests/EJ04_01/image.jpg");
	uint32_t tex2 = createTexture("../tests/EJ04_01/image2.jpg");
